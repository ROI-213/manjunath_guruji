...
export default function GalleryHero({ onNavigateHome = () => {} }) {
  const stars = [
    { top: '15%', left: '10%', size: 2.5, opacity: 0.8, delay: '0.2s', dur: '3s' },
    { top: '25%', left: '30%', size: 1.5, opacity: 0.6, delay: '1.2s', dur: '4s' },
    { top: '12%', left: '70%', size: 3, opacity: 0.9, delay: '0.8s', dur: '2.5s' },
  ...
  return (
    <section className="gallery-hero-universe-section" style={{
      position: 'relative',
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center', maxWidth: '850px' }}>
        ...
        <div style={{ 
          ...
          <span style={{ color: '#FFFFFF', fontWeight: 600 }}>Gallery</span>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '0.85rem' }}>
          <div className="badge-gold" style={{ 
            ...
            <span>Visual Archive &amp; Spiritual Gallery</span>
            <Sparkles size={13} style={{ color: '#FCD34D' }} />
          </div>
        </div>
        ...
        <p style={{ 
          ...
          Explore approved media covering Pandit Shekar Guruji’s spiritual activities, prayer ceremonies, and sacred consultation spaces.
        </p>
